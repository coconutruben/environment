...
- generously use sub-agents for exploration and other tasks when the tool supports them
...
When doing collaborative brainstorming or documentation with an agent, save files to `~/claudeandme/`:
